...
Static GitHub Pages package for TeamStation AI email signatures.

## What is included

- `index.html` — team-facing signature generator with live preview and copy buttons.
- `dist/lonnie.html` — Lonnie McRorey's ready-made signature page.
- `templates/teamstation-signature-template.html` — reusable HTML fragment with placeholders.
...
2. Enter the team member's name, title, email, phone, and calendar URL.
3. Click **Copy signature**.
4. Paste into Gmail or Outlook signature settings.
5. Send a test email to confirm the logo renders.
